<template>
  <el-breadcrumb class="app-breadcrumb" separator="/" style="height:50px;backgroundColor:rgba(112, 111, 67, 1);borderRadius:20px;padding:0px 20px 0px 40px;boxShadow:0px 0px 0px #f903d4;borderWidth:0;borderStyle:solid;borderColor:rgba(255, 255, 255, 1);">
